...
<?php
$sql = "SELECT * FROM `channel_payment` WHERE `channel_id` = '$id' AND `user` = '$user'";
...
if (empty($_POST)) {
   ...
   echo '<div>
                        <h4 style="margin-left: 16px;">Send Money to 01765403041 (bkash/Rocket/Nagad) '.$price.'Taka</h4>
   ...
   $user = $user;
   $id = $id;
   $sql = "INSERT INTO `channel_payment` (`ac`, `user`, `phone`,`address`, `txid`, `taka`,`channel_id`, `status`) VALUES ('$ac','$user', '$from','$address', '$txid', '$taka','$id','0')";
